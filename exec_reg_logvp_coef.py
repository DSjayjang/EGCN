...
def collate_emodel_elastic_7(samples):
    ...
    for i in range(0, len(samples)):
        ...
        self_feats[i, 4] = mol_graph.NumHDonors
        # 6
        self_feats[i, 5] = mol_graph.fr_ether
        self_feats[i, 6] = mol_graph.EState_VSA1
        ####################################################
...
def collate_emodel_elastic_10(samples):
    ...
    for i in range(0, len(samples)):
        ...
        self_feats[i, 5] = mol_graph.fr_ether
        self_feats[i, 6] = mol_graph.EState_VSA1
        self_feats[i, 7] = mol_graph.NumAliphaticHeterocycles
        self_feats[i, 8] = mol_graph.EState_VSA5
...
def collate_emodel_elastic_20(samples):
    ...
    for i in range(0, len(samples)):
        ...
        self_feats[i, 9] = mol_graph.SlogP_VSA10
        # 11
        self_feats[i, 10] = mol_graph.MinAbsEStateIndex
        self_feats[i, 11] = mol_graph.NumHAcceptors
        self_feats[i, 12] = mol_graph.fr_COO
        self_feats[i, 13] = mol_graph.SlogP_VSA8
        self_feats[i, 14] = mol_graph.SlogP_VSA1
        # 16
        self_feats[i, 15] = mol_graph.VSA_EState9
        self_feats[i, 16] = mol_graph.fr_azo
        self_feats[i, 17] = mol_graph.EState_VSA9
...
def collate_emodel_elastic(samples):
    ...
    for i in range(0, len(samples)):
        ...
        self_feats[i, 19] = mol_graph.VSA_EState8
        # 21
        self_feats[i, 20] = mol_graph.qed
        self_feats[i, 21] = mol_graph.fr_ketone_Topliss
        self_feats[i, 22] = mol_graph.fr_amidine
        self_feats[i, 23] = mol_graph.fr_Al_OH_noTert
        self_feats[i, 24] = mol_graph.FpDensityMorgan1
        # 26
        self_feats[i, 25] = mol_graph.fr_Nhpyrrole
        self_feats[i, 26] = mol_graph.PEOE_VSA13
        self_feats[i, 27] = mol_graph.fr_priamide
        self_feats[i, 28] = mol_graph.PEOE_VSA10
        self_feats[i, 29] = mol_graph.NumSaturatedHeterocycles
        # 31
        self_feats[i, 30] = mol_graph.FractionCSP3
        self_feats[i, 31] = mol_graph.SMR_VSA4
        self_feats[i, 32] = mol_graph.fr_ketone
        self_feats[i, 33] = mol_graph.fr_alkyl_carbamate
        self_feats[i, 34] = mol_graph.fr_amide
        # 36
        self_feats[i, 35] = mol_graph.fr_lactone
        self_feats[i, 36] = mol_graph.SlogP_VSA4
        self_feats[i, 37] = mol_graph.SMR_VSA5
        self_feats[i, 38] = mol_graph.PEOE_VSA9
        self_feats[i, 39] = mol_graph.fr_NH1
        # 41
        self_feats[i, 40] = mol_graph.fr_nitrile
        self_feats[i, 41] = mol_graph.fr_piperdine
        ####################################################
