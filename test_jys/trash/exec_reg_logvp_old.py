...
model_Extended_EGCN_20_e2 = EGCN_20_e2.Net(mc.dim_atomic_feat, 1, 20).to(device)

model_Extended_EGCN_sf = Outer_EGCN_elastic.Net(mc_sf.dim_atomic_feat, 1, mc_sf.dim_self_feat).to(device)
